            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form action="" method="POST" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="space-y-2">
                                <div class="flex items-center">
                                    <input type="radio" id="pernah_relawan_pernah" name="pernah_relawan" value="pernah" 
                                           class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300"
                                           onchange="toggleNamaKegiatan()">
                                    <label for="pernah_relawan_pernah" class="ml-2 text-sm text-gray-700">Pernah</label>
                                </div>
                                <div class="flex items-center">
                                    <input type="radio" id="pernah_relawan_belum" name="pernah_relawan" value="belum" 
                                           class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300"
                                           onchange="toggleNamaKegiatan()">
                        ...
                        <div id="nama_kegiatan_field" style="display: none;">
                        ...
                        <div>
                            ...
                            <div class="space-y-2">
                                <div class="flex items-center">
                                    <input type="radio" id="siap_kontribusi_ya" name="siap_kontribusi" value="ya" 
                                           class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300">
                                    <label for="siap_kontribusi_ya" class="ml-2 text-sm text-gray-700">Ya, siap berkontribusi</label>
                                </div>
                                <div class="flex items-center">
                                    <input type="radio" id="siap_kontribusi_tidak" name="siap_kontribusi" value="tidak" 
                                           class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300">
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center justify-center w-full">
                                        <label for="bukti_follow" class="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100">
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center justify-center w-full">
                                        <label for="bukti_repost" class="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100">
                                            <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                                <svg class="w-8 h-8 mb-4 text-gray-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 16">
                                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 13h3a3 3 0 0 0 0-6h-.025A5.56 5.56 0 0 0 16 6.5 5.5 5.5 0 0 0 5.207 5.021C5.137 5.017 5.071 5 5 5a4 4 0 0 0 0 8h2.167M10 15V6m0 0L8 8m2-2 2 2"/>
                                                </svg>
